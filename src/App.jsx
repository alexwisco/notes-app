...
const deleteNote = (id) => {
  ...
  if (window.confirm(`Delete ${objTitle} note?`)) { // if user is sure
    noteService
    ...
    <h1> Notes App </h1>
      <div className = "app-container">
        ...
        <form className='note-form' onSubmit={addNote}>
          <input placeholder="Title" value = {newTitle} onChange={handleTitleChange} required/>
          <textarea placeholder='Content' value = {newContent} onChange={handleContentChange} rows = {10} required/>
